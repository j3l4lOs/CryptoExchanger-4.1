                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td><span class="pull-right"><?php echo date("d/m/Y H:i:s",$row['created']); ?></span></td>
                                </tr>
                                <tr>
                                    <td><b>Order updated on:</b></td>
                                    <td><span class="pull-right"><?php if($row['updated']>0) { echo date("d/m/Y H:i:s",$row['updated']); } ?></span></td>
                                </tr>
                                <tr>
                                    <td><b>Order expired on:</b></td>
                                    <td><span class="pull-right"><?php if($row['expired']>0) { echo date("d/m/Y H:i:s",$row['expired']); } ?></span></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                                ...
                                if($GetFiles->num_rows>0) {
                                    while($file = $GetFiles->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date("d/m/Y H:i",$file['uploaded']); ?></td>
                                        </tr>
                                        <?php
                                    }
                                } else {
