...
<head>
  ...
  <title><?php echo $settings['name']; ?> CE Admin</title>
  <!-- plugins:css -->
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./?a=discount_system"><i class="fa fa-percent  menu-icon"></i> <span class="menu-title">Discount System</span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="./?a=users"><i class=" ti-user  menu-icon"></i> <span class="menu-title">Users</span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="./?a=operators"><i class="fa fa-user-secret  menu-icon"></i> <span class="menu-title">Operators</span></a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./?a=templates"><i class="ti-palette  menu-icon"></i> <span class="menu-title">Templates</span></a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./?a=settings&b=web"><i class="fa fa-cogs menu-icon"></i> <span class="menu-title">Web Settings</span></a>
          </li>
